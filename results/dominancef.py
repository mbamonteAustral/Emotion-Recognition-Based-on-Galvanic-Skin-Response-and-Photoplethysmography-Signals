...
def dominance (participant, window_seconds, overlap_percentage):
    ...
    try:
        ...
        participant = str(10)  # original = 28 
    ...
    return prevalence_aro, prevalence_val
...
if __name__ == "__main__":
    ...
    overlap_percentage = 0.0
    participant = 3
    dominance(participant, window_seconds, overlap_percentage)
