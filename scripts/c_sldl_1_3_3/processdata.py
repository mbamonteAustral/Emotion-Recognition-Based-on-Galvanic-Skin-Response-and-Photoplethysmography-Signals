...
combined_df_mapped = map_valence_arousal(combined_df_median, scheme = 'bipartite', number_thresholds = 2, threshold = 5, L = 3, H = 7)
# combined_df_mapped = map_valence_arousal(combined_df_median, scheme = 'bipartite', number_thresholds = 1, threshold = 5, L = 3, H = 7)

combined_df_mapped.reset_index(drop=True, inplace=True)

combined_df_mapped.dropna(inplace=True)

print(combined_df_mapped.val_chunks.iloc[0].isna().any())
