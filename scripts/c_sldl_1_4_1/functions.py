...
def calc_metrics2(expected, predicted):
    """
    the same as calc_metrics but returns 5 metrics instead of 4: 
    cohen_kappa_score_value, uar, accuracy, gmean, f1_score_macro
    ...
    return [cohen_kappa_score_value, uar, accuracy, gmean, f1_score_macro]
